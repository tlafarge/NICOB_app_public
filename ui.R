...
shinyUI(fluidPage(id = "fullpage",theme = "style.css",
                  ...
                  tags$head(HTML("<script async src='https://www.googletagmanager.com/gtag/js?id=UA-114531707-1'></script>")),

                  tags$head(HTML("<script>  window.dataLayer = window.dataLayer || [];  function gtag(){dataLayer.push(arguments);}  gtag('js', new Date()); gtag('config', 'UA-114531707-1');</script>")),
  ...
  # ),
  ## for now will hide the error messages on DoE plots and tables when bootstrap =0
  fluidRow(id = "content",
    column(12,
